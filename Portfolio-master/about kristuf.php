...
<section class="about" id="about">
   ...
   <h1 class="heading" data-aos="fade-up"> <span>About kristuf lamonte</span> </h1>

   <div class="biography">

      <p data-aos="fade-up"> It contains the information all about kristuf lamonte.</p>

      <div class="bio">
         <h3 data-aos="zoom-in"> <span>from: </span> Gasan, Marinduque</h3>
         <h3 data-aos="zoom-in"> <span>school : </span> Marinduque State College </h3>
         <h3 data-aos="zoom-in"> <span>year: </span> 2nd Year College </h3>
         <h3 data-aos="zoom-in"> <span>email: </span> kristuflamonte29@gmail.com</h3>
         <h3 data-aos="zoom-in"> <span>contact: </span> 09455749661</h3>
